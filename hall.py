...
ft4 = pv.Box(bounds=(-3.0, -2.5, 5.0, 6.0, -0.5, 0.0), level=4)
ft5 = pv.Box(bounds=(2.5, 3.0, 5.0, 6.0, -0.5, 0.0), level=4)
...
plotter.add_mesh(ft4, color='grey')
plotter.add_mesh(ft5, color='grey')
